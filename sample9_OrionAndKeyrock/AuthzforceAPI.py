...
class AuthzforceAPI():
    def __init__(self, baseURL):
        ...
        __METHODS_TABLE = {
            ...
            "postAuthzforceCeDomains"   : lambda self: ["/authzforce-ce/domains",   "get",     {**__HEADERS, **{'Content-Type':'application/xml'}}],
        }
    ...
    def __httpReq(self, func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if(body==None):
                ...
                response = requests.request(method, url=paths, headers=headers, params=query, data=body, timeout=5)
