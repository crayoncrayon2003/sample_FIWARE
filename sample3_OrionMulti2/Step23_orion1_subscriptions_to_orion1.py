...
FROM_SERVICE = 'service3'            # multi-tenant name
FROM_SERVICEPATH = '/servicepath3'   # data storage path

TO_SERVICE = 'service4'            # multi-tenant name
TO_SERVICEPATH = '/servicepath4'   # data storage path
